...
#include "fully_connected_kernel_bf_tiled_taylor.h"
...
FullyConnected_bf_tiled_taylor::FullyConnected_bf_tiled_taylor() : FullyConnectedKernelBase("fully_connected_gpu_bf_taylor") {
...
ParamsKey FullyConnected_bf_tiled_taylor::GetSupportedKey() const {
    ParamsKey k;
...
DeviceFeaturesKey FullyConnected_bf_tiled_taylor::get_required_device_features_key(const Params& params, const optional_params& options) const {
...
bool FullyConnected_bf_tiled_taylor::Validate(const Params& params, const optional_params& options) const {
...
struct TuneParamsSelector {
    using tune_params = FullyConnected_bf_tiled_taylor::tune_params;
...
FullyConnected_bf_tiled_taylor::tune_params
FullyConnected_bf_tiled_taylor::GetAutoTuneParams(const fully_connected_params& params, int idx) const {
...
FullyConnected_bf_tiled_taylor::DispatchData
FullyConnected_bf_tiled_taylor::SetDefault(const fully_connected_params& params, int autoTuneIndex) const {
...
JitConstants FullyConnected_bf_tiled_taylor::GetJitConstants(const fully_connected_params& params, const DispatchData& dispatchData) const {
...
KernelsData FullyConnected_bf_tiled_taylor::GetTunedKernelsDataByIndex(const Params &params,
...
KernelsData FullyConnected_bf_tiled_taylor::GetKernelsDataForAutoTune(const Params& params, const optional_params& options) const {
    KernelsData res = {};
...
KernelsData FullyConnected_bf_tiled_taylor::GetKernelsData(const Params& params, const optional_params& optParams) const {
    KernelsData res = {};
    auto& fc_params = static_cast<const fully_connected_params&>(params);
