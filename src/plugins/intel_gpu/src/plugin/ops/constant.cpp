...
//    }
    ...
    cldnn::layout constLayout = p.use_new_shape_infer() ? cldnn::layout(constTensor, out_dtype, constFormat) :
                                                          cldnn::layout(out_dtype, constFormat, tensor_from_dims(constTensor.to_shape()));
