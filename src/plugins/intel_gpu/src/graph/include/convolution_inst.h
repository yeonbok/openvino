...
public:
    ...
    program_node& weights(size_t idx = 0) const {
        ...
        return *get_dependency_new(1 + idx + get_deform_conv_dep_offset()).first;
    }
    ...
    program_node& bias(size_t idx = 0) const {
        ...
        return *get_dependency_new(1 + this->get_split() + idx + get_deform_conv_dep_offset()).first;
    }
    ...
    program_node& weights_zero_points(size_t idx = 0) const {
        ...
        return *get_dependency_new(1 + (1 + 1 * bias_term()) * this->get_split() + idx + get_deform_conv_dep_offset()).first;
    }
    ...
    program_node& activations_zero_points(size_t idx = 0) const {
        ...
        return* get_dependency_new(1 + (1 + 1 * bias_term() + 1 * weights_zero_points_term()) * this->get_split() + idx +
    ...
    program_node& compensation(size_t idx = 0) const {
        ...
        return *get_dependency_new(1 + (1 + 1 * bias_term() + 1 * weights_zero_points_term() + 1*activations_zero_points_term()) * this->get_split()
    ...
    program_node& trans() const {
        ...
        return *get_dependency_new(1).first;
    }
    ...
    program_node& mask() const {
        ...
        return *get_dependency_new(2).first;
    }
