...
struct primitive_impl {
    ...
    virtual void update_command(command_list* list, const std::vector<event::ptr>& events, primitive_inst& instance) { OPENVINO_NOT_IMPLEMENTED; }
...
public:
    ...
    std::vector<event::ptr> prepare_primitive(const std::vector<event::ptr>& events, bool* impl_updated);
    void add_to_command_list(command_list* list);
    void update_command(command_list* list);
...
private:
    ...
    virtual event::ptr add_to_cmd_list_impl(command_list* list, const std::vector<event::ptr>& event, typed_primitive_inst<PType>& instance) {
        OPENVINO_NOT_IMPLEMENTED;
    }

    virtual void update_command_impl(command_list* list, const std::vector<event::ptr>& event, typed_primitive_inst<PType>& instance) {
        OPENVINO_NOT_IMPLEMENTED;
    }
};
