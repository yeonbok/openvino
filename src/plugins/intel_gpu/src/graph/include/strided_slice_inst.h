...
public:
    ...
    static std::vector<layout> calc_output_layouts(strided_slice_node const& node, kernel_impl_params const& impl_param, const std::map<int, memory::ptr> constant_mem);
