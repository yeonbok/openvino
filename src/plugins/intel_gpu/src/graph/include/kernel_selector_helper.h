...
inline void convert_fused_activation_func_params_taylor(const prim_kernel_params& param_info, std::vector<kernel_selector::base_activation_params>& params) {
...
//    const auto& output_layout = arg.get_output_layout();
    ...
    convert_fused_activation_func_params_taylor(param_info, params.activations);
