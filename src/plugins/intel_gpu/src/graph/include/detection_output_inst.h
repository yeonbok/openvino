...
public:
    ...
    program_node& location() const { return *get_dependency_new(0).first; }
    program_node& confidence() const { return *get_dependency_new(1).first; }
    program_node& prior_box() const { return *get_dependency_new(2).first; }
};
