...
void loop_inst::preprocess_output_memory() {
    ...
    for (size_t i = 0; i < _output_primitive_maps.size(); ++i) {
        ...
        if (output_mapping.axis < 0) {
            ...
            std::cout << "preprocess_output_memory ! " << std::endl;
            std::cout << "  -- extern : " << external_id << std::endl;
            std::cout << "  -- internal : " << internal_id << std::endl;
            ...
            for (int j=0; j < max_iteration; ++j) {
                ...
                std::cout << "         sliced mem " << j << " : " << sliced_layout.to_string() << std::endl;
            }
