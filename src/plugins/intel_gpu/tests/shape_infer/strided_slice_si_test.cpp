...
TEST_P(strided_slice_test, shape_infer) {
    ...
    auto& node = const_cast<cldnn::strided_slice_node&>(dynamic_cast<const cldnn::strided_slice_node&>(strided_slice_node));
    node.const_mem = {begin_mem, end_mem, strides_mem};
