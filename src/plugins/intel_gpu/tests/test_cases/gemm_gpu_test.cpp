...
TEST(gemm_gpu, basic_bfyx_t1) {
    ...
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 1, 4 } });
...
TEST(gemm_gpu, basic_bfyx_t2) {
    auto& engine = get_test_engine();
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 4, 3 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 4, 1 } });
...
TEST(gemm_gpu, basic_bfyx_t1t2) {
    auto& engine = get_test_engine();
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 2, 1, 3, 4 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 2, 1, 4, 1 } });
...
TEST(gemm_gpu, basic_input3) {
    auto& engine = get_test_engine();
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 3, 2 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 2, 3 } });
    auto input3 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 2, 2 } });
    float alpha = 2.f;
    float beta = 10.f;
...
TEST(gemm_gpu, basic_input3_t1t2) {
    auto& engine = get_test_engine();
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 4, 3 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 3, 2 } });
    auto input3 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 1, 1, 2, 4 } });
    float alpha = 2.f;
    float beta = 3.f;
...
TEST(gemm_gpu, basic_bfyx) {
    auto& engine = get_test_engine();
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 2, 1, 4, 3 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 2, 1, 1, 4 } });
...
TEST(gemm_gpu, basic3_bfyx) {
    auto& engine = get_test_engine();
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 5, 1, 500, 9 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 5, 1, 1, 500 } });
...
TEST(gemm_gpu, basic_smarcink2) {
    auto& engine = get_test_engine();
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 2, 1, 3, 2 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, tensor{ 2, 1, 2, 3 } });
