...
<<<<<<< HEAD
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 3, 4 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 1, 4 } });
||||||| parent of fb13ce5dae... [GPU] Fixes after rebase
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 4, 3 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 4, 1 } });
=======
...
>>>>>>> fb13ce5dae... [GPU] Fixes after rebase
...
TEST(gemm_gpu, basic_input3) {
    auto& engine = get_test_engine();
<<<<<<< HEAD
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 3, 2 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 2, 3 } });
    auto input3 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 2, 2 } });
||||||| parent of fb13ce5dae... [GPU] Fixes after rebase
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 2, 3 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 3, 2 } });
    auto input3 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 2, 2 } });
=======
...
<<<<<<< HEAD
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 4, 3 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 3, 2 } });
    auto input3 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 2, 4 } });
||||||| parent of fb13ce5dae... [GPU] Fixes after rebase
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 3, 4 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 2, 3 } });
    auto input3 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 1, 1, 4, 2 } });
=======
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, { 1, 1, 4, 3 } });
...
TEST(gemm_gpu, basic3_bfyx) {
    auto& engine = get_test_engine();
<<<<<<< HEAD
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 5, 1, 500, 9 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 5, 1, 1, 500 } });
||||||| parent of fb13ce5dae... [GPU] Fixes after rebase
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 5, 1, 9, 500 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 5, 1, 500, 1 } });
=======
...
TEST(gemm_gpu, basic_smarcink2) {
    auto& engine = get_test_engine();
<<<<<<< HEAD
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 2, 1, 3, 2 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 2, 1, 2, 3 } });
||||||| parent of fb13ce5dae... [GPU] Fixes after rebase
    auto input = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 2, 1, 2, 3 } });
    auto input2 = engine.allocate_memory({ data_types::f32, format::bfyx, ov::PartialShape{ 2, 1, 3, 2 } });
=======
