...
public:
    cldnn::memory::ptr run_concat_network(std::vector<std::vector<std::vector<std::vector<std::vector<Type>>>>> input, format::type fmt, build_options options) {
        ...
        topology.add(reorder("reorder", "pool_final", layout(data_type, format::bfyx, ov::PartialShape{(int32_t)batch_num, (int32_t)output_f, (int32_t)input_y, (int32_t)input_x})));
