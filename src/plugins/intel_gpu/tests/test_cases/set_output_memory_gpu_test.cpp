...
TEST(set_output_memory_gpu, mutable_output_data) {
    ...
    topology.add(arg_max_min("arg_max", { "Add_1396", "second_input", "12220_md_write" }, {{"Add_1396", 0}, {"second_input",0}, {"12220_md_write", 0}}, arg_max_min::min, top_k, arg_max_min::batch));
