...
std::shared_ptr<cldnn::engine> fake_engine::create(const device::ptr device, runtime_types runtime_type, const engine_configuration& configuration) {
    return std::make_shared<fake::fake_engine>(device, runtime_type, configuration);
}
std::shared_ptr<cldnn::engine> create_fake_engine(const device::ptr device, runtime_types runtime_type, const engine_configuration& configuration) {
    return fake_engine::create(device, runtime_type, configuration);
}
}  // namespace fake
} // namespace cldnn
