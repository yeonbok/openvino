...
// permute_tile_8x8
#define CASE_PERMUTE_TILE_8X8_4D_0 {1, 8, 8, 2}, {1, 2, 8, 8}, {0, 3, 1, 2}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_TILE_8X8_4D_1 {1, 5, 8, 2}, {1, 2, 5, 8}, {0, 3, 1, 2}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_TILE_8X8_4D_2 {1, 8, 5, 2}, {1, 2, 8, 5}, {0, 3, 1, 2}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_TILE_8X8_4D_3 {1, 5, 5, 2}, {1, 2, 5, 5}, {0, 3, 1, 2}, tensor{0}, data_types::f32, format::bfyx, data_types::f32, format::bfyx
#define CASE_PERMUTE_TILE_8X8_5D_0 {1, 8, 8, 2, 2}, {1, 2, 8, 8, 2}, {0, 4, 1, 2, 3}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_PERMUTE_TILE_8X8_5D_1 {1, 5, 8, 2, 2}, {1, 2, 5, 8, 2}, {0, 4, 1, 2, 3}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_PERMUTE_TILE_8X8_5D_2 {1, 8, 5, 2, 2}, {1, 2, 8, 5, 2}, {0, 4, 1, 2, 3}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_PERMUTE_TILE_8X8_5D_3 {1, 5, 5, 2, 2}, {1, 2, 5, 5, 2}, {0, 4, 1, 2, 3}, tensor{0}, data_types::f32, format::bfzyx, data_types::f32, format::bfzyx
#define CASE_PERMUTE_TILE_8X8_6D_0 {1, 8, 8, 2, 2, 2}, {1, 2, 8, 8, 2, 2}, {0, 5, 1, 2, 3, 4}, tensor{0}, data_types::f32, format::bfwzyx, data_types::f32, format::bfwzyx
#define CASE_PERMUTE_TILE_8X8_6D_1 {1, 5, 8, 2, 2, 2}, {1, 2, 5, 8, 2, 2}, {0, 5, 1, 2, 3, 4}, tensor{0}, data_types::f32, format::bfwzyx, data_types::f32, format::bfwzyx
#define CASE_PERMUTE_TILE_8X8_6D_2 {1, 8, 5, 2, 2, 2}, {1, 2, 8, 5, 2, 2}, {0, 5, 1, 2, 3, 4}, tensor{0}, data_types::f32, format::bfwzyx, data_types::f32, format::bfwzyx
#define CASE_PERMUTE_TILE_8X8_6D_3 {1, 5, 5, 2, 2, 2}, {1, 2, 5, 5, 2, 2}, {0, 5, 1, 2, 3, 4}, tensor{0}, data_types::f32, format::bfwzyx, data_types::f32, format::bfwzyx
...
INSTANTIATE_TEST_CASE_P(fusings_gpu, permute_activation_scale_eltwise,
                        ::testing::ValuesIn(std::vector<permute_params> {
                            ...
                            // Fusing tests for permute_tile_8x8
                            permute_params{CASE_PERMUTE_TILE_8X8_4D_0, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_4D_1, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_4D_2, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_4D_3, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_5D_0, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_5D_1, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_5D_2, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_5D_3, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_6D_0, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_6D_1, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_6D_2, 2, 5},
                            permute_params{CASE_PERMUTE_TILE_8X8_6D_3, 2, 5},
                        }), );
...
INSTANTIATE_TEST_CASE_P(fusings_gpu, permute_scale_eltwise_actv_scale_actv,
                        ::testing::ValuesIn(std::vector<permute_params> {
                            ...
                            // Fusing tests for permute_tile_8x8
                            permute_params{CASE_PERMUTE_TILE_8X8_4D_0, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_4D_1, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_4D_2, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_4D_3, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_5D_0, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_5D_1, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_5D_2, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_5D_3, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_6D_0, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_6D_1, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_6D_2, 2, 7},
                            permute_params{CASE_PERMUTE_TILE_8X8_6D_3, 2, 7},
                        }), );
